@extends('cms.parent')
@section('title', 'Financial Operation')


@section('page-title', 'Financial Operations')
@section('home-page', 'home')
@section('sub-page', 'Financial Operation')
@section('styles')
     <!-- Toastr -->
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">Financial Operation</h3>
