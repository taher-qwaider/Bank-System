      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="card card-primary">
            ...
            @endif
            @if (session()->has('SaveMassege'))
                <div class="card-body">
                    <div class="alert alert-success alert-dismissible">
                    <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                    <h5><i class="far fa-check-circle"></i> {{ session('SaveMassege') }}</h5>
                    </div>
                </div>
            @endif
            <!-- /.card-header -->
            ...
            <form role="form" method="POST" action="{{ route('Profession.store') }}">
              ...
              <div class="card-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="proName" name="name" value="{{ old('name') }}" placeholder="Enter Name">
                </div>
                <div class="form-group">
                    <div class="custom-control custom-switch">
                      <input type="checkbox" class="custom-control-input" name="active" id="pro-active" checked>
